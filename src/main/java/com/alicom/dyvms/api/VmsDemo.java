...
public class VmsDemo {
    ...
    static final String accessKeyId = "LTAI4FvKj8r71qPCyfHB18zp";
    static final String accessKeySecret = "jibc21vImLZS8qP6Z3crhYLgV1tU7H";
    ...
    *//**
    ...
    public static void main(String[] args) {
        ...
        CommonRequest request = new CommonRequest(product,"2017-05-25","SingleCallByTts",domain);
        request.putQueryParameter("RegionId", "cn-hangzhou");
        //被叫显示号码信息
        request.putQueryParameter("CalledShowNumber", "");
        //被叫号码
        request.putQueryParameter("CalledNumber", "18720356426");
        request.putQueryParameter("TtsCode", "TTS_10001");
        request.putQueryParameter("TtsParam", "{“AckNum”:”123456”}");
